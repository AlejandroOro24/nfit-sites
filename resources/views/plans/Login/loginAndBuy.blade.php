                ...
                <div>
                    ...
                    <div class="grid grid-cols-1 lg:grid-cols-3 gap-7">
                        ...
                        <div class="stepper lg:order-1 lg:col-start-1 lg:col-end-4">
                            <p class="active">Paso 1: Accede</p>
                            <p>Paso 2: Pago</p>
                        </div>
                        <!-- Form -->
                        <div class="lg:order-2 lg:col-start-1 lg:col-end-3">
                            <form action="{{route('loginAndBuy.store' ,['id' => $getplan->id , 'tenant' => $subdomain])}}" method="POST" class="form">
                                @csrf
                                ...
                                <input type="submit" value="Iniciar Sesión" class="input-button active">
                            </form>
                            <div class="text-center mt-2">
                                <a href="/buy-plan/with-login/reset.html" class="link">Olvidé mi clave</a>
                            </div>
                        </div>
                    </div>
                </div>
