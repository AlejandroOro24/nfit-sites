            ...
            <section class="menu" id="menu">
                ...
                <div class="complementary">
                    ...
                    <div class="mobile-profile-avatar">
                        <div class="avatar">
                            <div class="image" :style="`background-image: url(${auth_user});`"></div>
                            <div class="data">
                                <h5>{{ upperCaseFirstLetter(auth_user) }}</h5>
                                <p>{{ upperCaseFirstLetter(roles[auth_user]) }}</p>
                            </div>
                        </div>
                    </div>
                    <div class="mobile-profile-avatar">
...
<script>
    ...
    export default {
        ...
        mounted() {
            console.log('estas sidebar',this.auth_user);
            console.log('estas roles',this.roles);
