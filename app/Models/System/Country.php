...
class Country 
{
    public static function list()
    {
        return [
            ...
            ['prefix' => '+1',   'avatar' => public_path('img/countries/usa.png'), 'currency_symbol' => '$', 'code' => 'US', 'name' => 'USA (Miami)'],
    ...
    /**
     *  @param   string  by default gonna be Chile $ if nothing it's passed as parameter
     *
